...
def Perceptron(Feature, Label):
    ...
    while True:
        ...
        while a * y[h].T <= 0:
            ...
            #print(b)
            a = a + b
            t=Test(Feature, Label, a)
            #print("change a to" , a)
            learningRate = learningRate *0.9 # 步长缩减
...
Train= Perceptron(TrainSet1[0], TrainSet1[1])
print(Train)
print(Test(TestSet1[0], TestSet1[1], Train))

TrainSet2 = OpenFile('train_data_E3E5_2genes.txt')
TestSet2 = OpenFile('test_data_E3E5_2genes.txt')
Train2 = Perceptron(TrainSet2[0], TrainSet2[1])
print(Test(TestSet2[0], TestSet2[1], Train2))
